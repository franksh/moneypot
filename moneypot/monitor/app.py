...
PRICE_SCALES = ['Normal', 'Logarithmic', 'Percentage', 'IndexedTo100']
TIME_INTERVALS = ['1min', '5min', '15min', '1H', '1D', '1W']
...
if menu_option == 'Ticker Coins':
    ...
    chart_priceScaleMode = col1.selectbox("Price Scale", PRICE_SCALES)

    chart_timeInterval = col2.selectbox("Time Interval", TIME_INTERVALS)
